...
namespace RepositoryPatternGenerator.MainCommand
{
    ...
    public sealed class MainCommandPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "adaa0797-3f2f-4f0d-9d5d-0fe2f189f1a5";

        /// <summary>
        /// Initializes a new instance of the <see cref="MainCommand"/> class.
        /// </summary>
        public MainCommandPackage()
        {
        ...
        {
            RepositoryPatternGenerator.MainCommand.MainCommand.Initialize(this);
            base.Initialize();
        }
